...
import "https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.5-clinical-improvements/module00c/TestUtils.wdl" as tu
...
workflow Module00cMetrics {
  ...
  scatter (i in range(length(samples))) {
    ...
    Array[File] sample_metric_files_ = select_all([Manta_Std_Metrics.out, Melt_Std_Metrics.out, Wham_Std_Metrics.out])
  }
