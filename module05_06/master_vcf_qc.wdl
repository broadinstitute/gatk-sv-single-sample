...
import "https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.6.1/module05_06/sharded_qc_collection.wdl" as ShardedQcCollection
import "https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.6.1/module05_06/collect_qc_per_sample.wdl" as CollectQcPerSample
import "https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.6.1/module05_06/per_sample_external_benchmark.wdl" as PerSampleExternalBenchmark

import "https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.6.1/module05_06/common_mini_tasks.wdl" as MiniTasks
...
task PlotQcPerFamily {
  ...
  # when filtering/sorting/etc, memory usage will likely go up (much of the data will have to
  # be held in memory or disk while working, potentially in a form that takes up more space)
  Float input_size = size([vcf_stats, samples_list, fam_file, per_sample_tarball], "GiB")
  Float compression_factor = 5.0
  Float base_disk_gb = 5.0
  # give extra base memory in case the plotting functions are very inefficient
  Float base_mem_gb = 3.75
